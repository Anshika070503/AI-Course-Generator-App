...
function CourseCard({course}) {
  return (
    <div className='shadow-sm rounded-lg border-black p-2 hover:scale-105 transition-all cursor-pointer mt-4'>
      <Image src={course?.courseBanner} alt="Course Card" width={300} height={200}
      className='w-full h-[200px]  object-cover rounded-lg'/>
      <div className='p-2'>
        <h2 className='font-medium text-medium'>{course?.courseOutput?.["Course Name"]}</h2>
